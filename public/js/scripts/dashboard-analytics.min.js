!function (o, e) {
    ...
    var a, r = e("#revenue-line-chart"), i = {
    ...
    var l, n = {
        ...
        options: {
            ...
            hover: {mode: "label"},
            scales: {
                xAxes: [{display: !0, gridLines: {display: !1}, ticks: {fontColor: "#fff"}}],
                yAxes: [{
                    display: !0,
                    fontColor: "#fff",
        ...
        data: i
    }, d = e("#doughnut-chart"), s = {
        type: "doughnut",
        options: b = {cutoutPercentage: 70, legend: {display: !1}},
        data: {
            labels: ["Mobile", "Kitchen", "Home"],
            datasets: [{label: "Sales", data: [3e3, 500, 1e3], backgroundColor: ["#F7464A", "#46BFBD", "#FDB45C"]}]
        }
    }, f = e("#trending-bar-chart"), p = {
    ...
    var h, c = {
        ...
        options: {
            ...
            scales: {
                ...
                yAxes: [{display: !0, fontColor: "#fff", gridLines: {display: !1}, ticks: {beginAtZero: !0}}]
            },
            tooltips: {
                titleFontSize: 0, callbacks: {
                    label: function (o, e) {
                        return o.yLabel
                    }
                }
    ...
    var u = {type: "radar", options: b, data: C}, y = e("#line-chart"), k = {
        type: "line",
        options: {
            responsive: !0,
            legend: {display: !1},
