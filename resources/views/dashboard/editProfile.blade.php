                        ...
                        <div id="general">
                            <div class="card-panel">
                                ...
                                <div class="display-flex">
                                    <div class="media">
                                        <img src="{{asset('images/avatar/avatar-12.png')}}" class="border-radius-4"
                                    ...
                                    @csrf
                                        <div class="row">
                                            <div class="input-field col s12 m4">
                                                ...
                                                <input id="icon_prefix pl-3" type="text" name="name" class="validate" value="{{$user->name}}">
                                            ...
                                            <div class="input-field col s12 m4">
                                                ...
                                                <input id="icon_telephone" type="text" name="tel" class="validate" value="{{$user->tel}}">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <i class="material-icons prefix ">account_circle</i>
                                                <input id="icon_prefix pl-3" type="text" name="address" class="validate" value="{{$user->address}}">
                                                <label for="icon_prefix "> آدرس</label>
                                            </div>
                                        </div>
                                    <div class="row">
                        ...
                        <div class="slide-out-right-body row pl-3">
                            <div id="messages" class="col s12 pb-0">
                                <div class="collection border-none mb-0">
                                    <input class="header-search-input mt-4 mb-2 iransans" type="text" name="Search"
                                    ...
                                    <ul class="collection right-sidebar-chat p-0 mb-0">
                                        ...
                                        <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0"
                                            ...
                                            <div class="user-content">
                                                ...
                                                <p class="medium-small blue-grey-text text-lighten-3 pt-3">می تواند
                                                    انجام دهد؟</p>
                                            </div>
                                ...
                                <div class="activity">
                                    ...
                                    <ul class="widget-timeline mb-0">
                                        ...
                                        <li class="timeline-items timeline-icon-cyan active">
                                            ...
                                            <p class="timeline-text">در اینجا چند مفهوم تعامل با خوراک خبر آورده شده
                                                است.</p>
                                        ...
                                        <li class="timeline-items timeline-icon-red active">
                                            ...
                                            <p class="timeline-text">در اینجا خبر چند مفهوم تعامل با خوراک آورده شده
                                                است</p>
