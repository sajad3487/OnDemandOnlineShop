                    ...
                    <div class="card-content">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="{{$cartRequests['link']}}" target="_blank"
                                                   class="waves-effect waves-light btn-small s1"><i
                                                        class="material-icons left">cloud</i>مشاهده لینک</a>
                                            </td>
                                            <td>{{$cartRequests['quantity']}}</td>
                                            <td>{{$cartRequests['description']}}</td>
                                            <td>
                                                <form action="{{url("request/$cartRequests->id/delete")}}"
                                                      method="post">
                                                    @method('DELETE')
                                                    @csrf
                        ...
                        <div class="row mt-2">
                            <div class="col s12 display-flex justify-content-end form-action">
                                <a href="{{url('quotation/emptyCart')}}"
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div id="maintenance" class="col s12 center-align white">
                                ...
                                <h6 class="mb-6 mt-2 grey-text">لینک کالای مورد نظرت رو استعلام کن تا بصورت رایگان
                                    براتون پیشفاکتور صادر بشه</h6>
